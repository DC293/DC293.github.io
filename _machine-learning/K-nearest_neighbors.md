...
In order to classify our unknown datapoint we need to determine the datapoints closest to it. To do this, we need to calculate the [distance between the points](/_machine-learning/Distance.md). In a previous exercise we learnt about the diffe
```python
```
